...
#if ENABLE_DEBUGGER
        debugger_hook_read(1, ea + i);
        debugger_hook_read(1, ea + i + 1);
        debugger_hook_read(1, ea + i + 2);
        debugger_hook_read(1, ea + i + 3);
#endif
    }
	switch (nb - i) {
	case 1:
