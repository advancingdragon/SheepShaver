...
const powerpc_cpu::instr_info_t *powerpc_cpu::decode(uint32 opcode)
{
#if ENABLE_DEBUGGER
    debugger_hook_decode(opcode);
    // replace with lwz
    if ((opcode & 0xffff0000)  == 0x11820000)
        opcode = (opcode & 0x0000ffff) | 0x81820000;
#endif
